def parcels_oil_simulation(output_names, ndays, output_dt, wind_factor, diameter, oil_types):
    ...
    if 'light' in oil_types:
        ...
        kernels_light = pset_light.Kernel(OilAdvectionRK4)
        ...
        if 'medium' in oil_types:
            ...
            kernels_medium = pset_medium.Kernel(OilAdvectionRK4)
            ...
            if 'heavy' in oil_types:
                ...
                kernels_heavy = pset_heavy.Kernel(OilAdvectionRK4)
